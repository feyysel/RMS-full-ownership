...
export default function KitchenReceipts() {
  ...
  return (
    <div>
      <PageHeader
        title="Receipts"
        description="Every dish you've released — receipt generated by the cashier."
      />
          ...
          <AnimatePresence>
            {filtered.map((r) => (
              <motion.button
                ...
                className="flex w-full items-center gap-4 rounded-2xl border border-zinc-200 bg-gradient-to-br from-zinc-100 to-zinc-100 p-4 text-left shadow-soft backdrop-blur-sm transition-all dark:border-white/[0.08] dark:from-white/[0.06] dark:to-white/[0.01] hover:border-gold/30"
              >
            ...
            <div className="rounded-2xl border border-white/10 bg-white p-5 text-zinc-900">
              ...
              <div className="mt-4 border-t border-zinc-200 pt-3 text-xs text-zinc-500">
                <p className="flex justify-between">
                  <span>Processed by cashier</span>
